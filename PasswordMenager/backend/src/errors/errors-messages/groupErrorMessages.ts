export enum GroupModelErrorMap {
  FincByIdAndUpdate = 'Group repository > Group modal: findByIdAndUpdate method',
}
export enum GroupErrorMap {
  Create = 'Group repository: create method',
  FindById = 'Group repository: findById method',
